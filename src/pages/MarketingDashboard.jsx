...
export default function MarketingDashboard() {
  ...
  // 3. Update data statis (Pending Approval dihapus dari statistik)
  const stats = [
    { label: 'Total Campaigns', value: '38', color: 'text-white' },
    { label: 'Active Channels', value: '6', color: 'text-emerald-500' },
    { label: 'Deployed Strategies', value: historyLogs.length.toString(), color: 'text-purple-500' },
  ];
      ...
      <div className="bg-slate-900/20 border border-white/5 rounded-[2.5rem] overflow-hidden">
        <div className="p-6 border-b border-white/5 bg-white/[0.02] flex justify-between items-center">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-[9px] font-mono text-slate-500 uppercase tracking-widest">Archive Mode</span>
          </div>
        </div>
        
        <div className="p-2 transition-all duration-300">
          {isLoading ? (
            <div className="p-10 text-center text-slate-500 text-sm animate-pulse font-mono tracking-widest">RETRIEVING CAMPAIGN ARCHIVE...</div>
            ...
            <div className="p-10 text-center">
              ...
              <h4 className="text-white font-bold text-sm uppercase italic">Archive Empty</h4>
